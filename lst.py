...
if __name__ == '__main__':
    ...
    avoidleo.writelst(file_path, qth, parsed_args.num_seq, parsed_args.duration_seq, parsed_args.num_cren, parsed_args.file, parsed_args.time_start, parsed_args.incr)
